...
public class MainActivity extends Activity implements BluetoothAdapter.LeScanCallback {
    ...
    // twitter
	private final String API_KEY = "hy5Piy01xnQ06XqY2Kkw";
	private final String API_SECRET = "aECryLnKD7JbRnUIIFWIcrxg9iltqGmDKBdBIWjE";
	...
	private Handler updateHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			Log.d("MainActivity", "はんどらー通知内容:" + message);
			setRcvDataText("はんどらー通知内容:" + message);
		}
	};
